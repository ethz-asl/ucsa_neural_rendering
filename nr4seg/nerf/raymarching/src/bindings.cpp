...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    // m.def("composite_rays_train_semantics_forward", &composite_rays_train_semantics_forward, "composite_rays_train_forward (CUDA)");
    // m.def("composite_rays_train_semantics_backward", &composite_rays_train_semantics_backward, "composite_rays_train_backward (CUDA)");
    // infer
    m.def("march_rays", &march_rays, "march rays (CUDA)");
    // m.def("composite_rays_semantics", &composite_rays_semantics, "composite rays (CUDA)");
