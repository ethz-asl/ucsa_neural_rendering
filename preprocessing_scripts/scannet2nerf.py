# Partly based on https://github.com/ashawkey/torch-ngp/blob/main/scripts/
# colmap2nerf.py.
...
json_train_base = "transforms_train"
json_test_base = "transforms_test"
...
if args.room_center:
    ...
    room_center = (max_coord_mesh + min_coord_mesh) / 2.0
else:
...
out_path = os.path.join(scannet_folder, f"{json_train_base}.json")
...
out_path = os.path.join(scannet_folder, f"{json_test_base}.json")
with open(out_path, "w") as f:
